...
The test project operates an open contributor model where anyone is
...
The following applies to code changes to the test project, and is not to be
confused with overall test Network Protocol consensus changes.

Whether a pull request is merged into test rests with the project merge
...
Patches that change test consensus rules are considerably more involved than
...
Where a patch set proposes to change the test consensus, it must have been
...
The project leader is the release manager for each test release.
