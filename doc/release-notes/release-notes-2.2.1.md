...
test is extensively tested on multiple operating systems using
...
test should also work on most other Unix-like systems but is not
...
of Bitcoin that test was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/testcoin-translations/).
