...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a test address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and test: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About test"), this);
    aboutAction->setStatusTip(tr("Show information about test"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for test"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your test addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified test addresses"));
    ...
    openAction->setStatusTip(tr("Open a test: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the test help message to get a list with possible test command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("test client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("test"); // default title
